        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="https://www.facebook.com/share/18tfFUUktx/" aria-label="Facebook" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FFC702] transition-colors text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
              </a>
              <a href="https://www.instagram.com/ilyassweets_?igsh=ZWR5c21lZXByc2Fp" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FFC702] transition-colors text-white">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Privacy Policy", "Terms & Conditions", "Shipping Policy"].map((item) => {
                const slug = item === "Privacy Policy" ? "privacy" : item === "Terms & Conditions" ? "terms" : "contact";
                return (
                  <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-5 text-white/80 text-[15px]">
              <li className="flex items-start gap-4">
                ...
                <span className="leading-relaxed">Shop# 21-22, Jama Masjid Rashidia, Begum Khursheed Rd, Saudabad<br/>Karachi, Pakistan</span>
              </li>
